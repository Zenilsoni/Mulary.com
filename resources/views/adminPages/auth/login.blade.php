...
<form class="modal-content animate" action={{url('/login/admin')}}  method="POST">
    {{@csrf_field()}}
    <div class="imgcontainer">   
      <img src="{{asset('assets/images/admin_login.gif')}}">  
    </div>
    ...
    <div class="container">
      ...
      {!!$errors->first('admin_password','<div class="alert alert-danger">:message</div>')!!}
